                    ...
                    <tr key={cust._id} className="hover:bg-slate-50/80 transition-colors group">
                      ...
                      <td className="py-3.5 px-5">
                        <button onClick={() => handleToggleStatus(cust)}
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold transition-all cursor-pointer ${cust.status === "inactive" ? "bg-red-50 text-red-600 border border-red-200 hover:bg-red-100" : "bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100"
                            }`} title="Toggle status">
              ...
              <div key={cust._id} className="bg-white rounded-2xl border border-gray-200/80 p-5 hover:shadow-lg hover:border-indigo-500/20 transition-all duration-300 flex flex-col justify-between group">
                <div>
                  <div className="flex items-start justify-between gap-3 mb-3">
                    ...
                    <button onClick={() => handleToggleStatus(cust)}
                      className={`px-2 py-0.5 rounded-full text-[10px] font-bold border flex-shrink-0 ${cust.status === "inactive" ? "bg-red-50 text-red-600 border-red-200" : "bg-emerald-50 text-emerald-700 border-emerald-200"
