...
const BrandMaster = () => {
  ...
  // KPI Stats
  const stats = useMemo(() => {
    const total = totalCount || brands.length;
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }} className="pb-10 relative">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }} className="md:!flex-row md:!items-center md:!justify-between">
        <div>
          ...
          <p style={{ fontSize: 13, color: "#6b7280", marginTop: 4, margin: 0 }}>
            Manage equipment manufacturers, solar panel brands, and inverter vendors.
          </p>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            <span style={{ fontSize: 11, fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" }}>Total Brands</span>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, fontWeight: 500, color: "#9ca3af", marginTop: 2 }}>Registered Brands</div>
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            <span style={{ fontSize: 11, fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" }}>Active Brands</span>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            <span style={{ fontSize: 11, fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" }}>Inactive Brands</span>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, fontWeight: 500, color: "#9ca3af", marginTop: 2 }}>Archived Records</div>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 11, fontWeight: 600, color: "#d97706", marginTop: 2 }}>With Notes & Specs</div>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        <div style={{ backgroundColor: "#ffffff", borderRadius: 16, border: "1px solid #e5e7eb", padding: 60, textAlign: "center" }}>
          ...
          <h3 style={{ fontSize: 16, fontWeight: 700, color: "#111827", margin: 0 }}>Loading Brands...</h3>
        ...
        <div style={{ backgroundColor: "#ffffff", borderRadius: 16, border: "1px solid #e5e7eb", padding: 60, textAlign: "center" }}>
          ...
          <h3 style={{ fontSize: 16, fontWeight: 700, color: "#111827", margin: 0 }}>No Brands Found</h3>
          <p style={{ fontSize: 13, color: "#6b7280", maxWidth: 360, margin: "6px auto 20px auto", lineHeight: 1.5 }}>
            {search || statusFilter !== "all"
              ? "No brand records matched your search query or filter settings."
              : "No brands have been added yet. Click below to create your first brand entry."}
          </p>
          {search || statusFilter !== "all" ? (
            <button
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
              <thead>
                <tr style={{ backgroundColor: "#f9fafb", borderBottom: "1px solid #e5e7eb", fontSize: 11, fontWeight: 700, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                  <th style={{ padding: "14px 20px" }}>Brand Name</th>
                ...
                {paginatedBrands.map((brand) => (
                  ...
                  >
                    ...
                    <td style={{ padding: "14px 20px", color: "#6b7280", maxWidth: 280, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {brand.description || <span style={{ color: "#9ca3af", fontStyle: "italic" }}>No description</span>}
                    </td>
                    ...
                    <td style={{ padding: "14px 20px" }}>
                      <button
                        ...
                        style={{
                          ...
                          fontSize: 11,
                          fontWeight: 600,
                          border: brand.status === "inactive" ? "1px solid #fecaca" : "1px solid #bbf7d0",
                          backgroundColor: brand.status === "inactive" ? "#fef2f2" : "#f0fdf4",
                          color: brand.status === "inactive" ? "#dc2626" : "#16a34a",
                          cursor: "pointer",
                        }}
                        title="Toggle status"
                      >
                        <span style={{ width: 6, height: 6, borderRadius: "50%", backgroundColor: brand.status === "inactive" ? "#ef4444" : "#22c55e" }} />
                        <span>{brand.status === "inactive" ? "Inactive" : "Active"}</span>
                      </button>
                    </td>
              ...
              <div>
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 10, marginBottom: 14 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    ...
                    <div style={{ minWidth: 0 }}>
                      ...
                      <span style={{ fontSize: 11, color: "#9ca3af" }}>Brand Entity</span>
                    </div>
                  </div>
                ...
                <div style={{ padding: "12px 0", borderTop: "1px solid #f3f4f6", borderBottom: "1px solid #f3f4f6", margin: "12px 0", fontSize: 12 }}>
                  ...
                  <p style={{ color: "#374151", margin: 0, lineHeight: 1.5, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
                    {brand.description || <span style={{ color: "#9ca3af", fontStyle: "italic" }}>No description provided</span>}
                  </p>
                </div>
              </div>
      ...
      >
        <span style={{ fontSize: 12, fontWeight: 500, color: "#6b7280" }}>
          Showing {paginatedBrands.length} of {filteredBrands.length} brands (Page {page} of {computedTotalPages})
        </span>
            ...
            >
              ...
              <div style={{ padding: "20px 24px", background: "linear-gradient(180deg, #111113 0%, #1a1a1e 100%)", color: "#ffffff", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: 16, fontWeight: 700, margin: 0 }}>{inspectBrand.name}</h3>
                    <span style={{ fontSize: 11, color: "#9ca3af" }}>Brand Profile</span>
                  </div>
                </div>
                <button onClick={() => setInspectBrand(null)} style={{ background: "none", border: "none", color: "#9ca3af", cursor: "pointer", padding: 4 }}>
                  <X size={20} />
                </button>
              </div>
              ...
              <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 20, overflowY: "auto", flex: 1, fontSize: 13 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 16px", borderRadius: 12, backgroundColor: "#f9fafb", border: "1px solid #e5e7eb" }}>
                  ...
                  <span style={{ padding: "3px 10px", borderRadius: 20, fontSize: 11, fontWeight: 600, backgroundColor: inspectBrand.status === "inactive" ? "#fef2f2" : "#f0fdf4", color: inspectBrand.status === "inactive" ? "#dc2626" : "#16a34a", border: inspectBrand.status === "inactive" ? "1px solid #fecaca" : "1px solid #bbf7d0" }}>
                ...
                <div>
                  ...
                  <p style={{ color: "#374151", margin: 0, padding: 14, borderRadius: 12, backgroundColor: "#f9fafb", border: "1px solid #e5e7eb", lineHeight: 1.5 }}>
                    {inspectBrand.description || <span style={{ color: "#9ca3af", fontStyle: "italic" }}>No description specified.</span>}
                  </p>
                </div>
                ...
                <div style={{ paddingTop: 12, borderTop: "1px solid #f3f4f6", fontSize: 11, color: "#9ca3af", display: "flex", flexDirection: "column", gap: 4 }}>
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <span>Created:</span>
                    <span>{new Date(inspectBrand.createdAt).toLocaleString()}</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <span>Updated:</span>
                    <span>{new Date(inspectBrand.updatedAt).toLocaleString()}</span>
                  </div>
                </div>
              </div>
              ...
              <div style={{ padding: "16px 24px", backgroundColor: "#f9fafb", borderTop: "1px solid #e5e7eb", display: "flex", gap: 10 }}>
                <button
                  onClick={() => { const b = inspectBrand; setInspectBrand(null); handleEdit(b); }}
                  style={{
                    flex: 1,
                    height: 38,
                    borderRadius: 10,
                ...
                <button
                  onClick={() => { const b = inspectBrand; setInspectBrand(null); setDeleteTarget(b); }}
            ...
            >
              ...
              <div style={{ padding: "18px 24px", borderBottom: "1px solid #f3f4f6", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div>
                  <h3 style={{ fontSize: 17, fontWeight: 700, color: "#111827", margin: 0 }}>
                    {isEditing ? "Edit Brand Profile" : "Add New Brand"}
                  </h3>
                  <p style={{ fontSize: 12, color: "#6b7280", margin: "2px 0 0 0" }}>
                    Configure brand entry & vendor details.
                  </p>
                </div>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                <div style={{ padding: "14px 24px", backgroundColor: "#f9fafb", borderTop: "1px solid #f3f4f6", display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 10 }}>
                  ...
                  >
                    {submitting ? "Saving..." : isEditing ? "Save Changes" : "Create Brand"}
                  </button>
                </div>
              </form>
            </motion.div>
        ...
        {deleteTarget && (
          <div style={{ position: "fixed", inset: 0, zIndex: 60, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
            ...
            >
              ...
              <h3 style={{ fontSize: 16, fontWeight: 700, color: "#111827", margin: 0 }}>Delete Brand?</h3>
