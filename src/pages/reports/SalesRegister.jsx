...
const SalesRegister = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Sales Register</h2>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              <th className="py-3 px-4 font-semibold text-sm text-gray-700">Sale No</th>
            ...
            {loading ? (
              ...
              data.map((item) => (
                <tr key={item._id} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-gray-800">{item.saleNumber}</td>
