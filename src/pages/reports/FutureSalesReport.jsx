...
const FutureSalesReport = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Future Sales Report</h2>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              <th className="py-3 px-4 font-semibold text-sm text-gray-700">FS No</th>
              <th className="py-3 px-4 font-semibold text-sm text-gray-700">Order Date</th>
              <th className="py-3 px-4 font-semibold text-sm text-gray-700">Expected Date</th>
            ...
            {loading ? (
              ...
              data.map((item) => (
                <tr key={item._id} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-gray-800">{item.fsNumber}</td>
                  <td className="py-3 px-4 text-gray-600">{formatDate(item.orderDate)}</td>
                  <td className="py-3 px-4 text-gray-600">{formatDate(item.expectedDate)}</td>
